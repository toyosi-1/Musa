...
export default function MusaCharacterSVG({ 
  ...
  return (
    ...
    >
      ...
      {/* Background glow */}
      <circle cx="100" cy="120" r="90" fill="url(#backgroundGradient)" opacity="0.15" />
      
      {/* Body - kurta */}
      <ellipse cx="100" cy="160" rx="35" ry="50" fill="#B8860B" stroke="#8B4513" strokeWidth="2" />
      ...
      {/* Mouth */}
      <path d="M95 92 Q100 95 105 92" stroke="#654321" strokeWidth="1" fill="none" />
      ...
      <g opacity="0.7">
        ...
        <circle cx="140" cy="100" r="2" fill="#DAA520" />
      </g>
