    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          {...register}
          className="w-full h-12 px-4 pr-11 rounded-xl bg-[#1a2035] border border-white/15 text-white placeholder:text-gray-500 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all text-sm autofill-dark"
