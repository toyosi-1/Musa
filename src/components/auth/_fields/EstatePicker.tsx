    ...
    <div>
      ...
      <div className="relative">
        ...
        <select
          id="estateId"
          {...register}
          className="w-full h-12 pl-10 pr-10 rounded-xl bg-white/[0.08] border border-white/15 text-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all text-base appearance-none"
