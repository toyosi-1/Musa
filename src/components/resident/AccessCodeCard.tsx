...
export default function AccessCodeCard({ accessCode, onDeactivate }: AccessCodeCardProps) {
  ...
  return (
    <div className={`w-full max-w-[95%] mx-auto px-4 py-4 rounded-xl shadow-lg bg-white dark:bg-gray-900/80 border animate-fade-in transition-all duration-300 ${!accessCode.isActive || isExpired ? 'opacity-80' : 'hover:shadow-card-hover'}`}>
      {/* Status indicator */}
