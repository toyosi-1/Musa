...
export const metadata: Metadata = {
  ...
  appleWebApp: {
    ...
    startupImage: [
      ...
      { url: '/images/icon-512x512.png?v=v20250713_1752434150600', media: '(device-width: 320px) and (device-height: 568px)' },
      // iPhone 8, 7, 6s, 6
      { url: '/images/icon-512x512.png?v=v20250713_1752434150600', media: '(device-width: 375px) and (device-height: 667px)' },
      // iPhone 8 Plus, 7 Plus, 6s Plus, 6 Plus
      { url: '/images/icon-512x512.png?v=v20250713_1752434150600', media: '(device-width: 414px) and (device-height: 736px)' },
      // iPhone X, XS
      { url: '/images/icon-512x512.png?v=v20250713_1752434150600', media: '(device-width: 375px) and (device-height: 812px)' },
      // iPhone XR, XS Max
      { url: '/images/icon-512x512.png?v=v20250713_1752434150600', media: '(device-width: 414px) and (device-height: 896px)' },
    ],
  },
  ...
  icons: {
    icon: [
      ...
      { url: '/images/icon-72x72.png?v=v20250713_1752434150600', sizes: '72x72', type: 'image/png' },
      { url: '/images/icon-96x96.png?v=v20250713_1752434150600', sizes: '96x96', type: 'image/png' },
      { url: '/images/icon-128x128.png?v=v20250713_1752434150600', sizes: '128x128', type: 'image/png' },
      { url: '/images/icon-144x144.png?v=v20250713_1752434150600', sizes: '144x144', type: 'image/png' },
      { url: '/images/icon-152x152.png?v=v20250713_1752434150600', sizes: '152x152', type: 'image/png' },
      { url: '/images/icon-192x192.png?v=v20250713_1752434150600', sizes: '192x192', type: 'image/png' },
      { url: '/images/icon-384x384.png?v=v20250713_1752434150600', sizes: '384x384', type: 'image/png' },
      { url: '/images/icon-512x512.png?v=v20250713_1752434150600', sizes: '512x512', type: 'image/png' },
    ],
    shortcut: [
    ...
    apple: [
      ...
      { url: '/apple-touch-icon.png?v=v20250713_1752434150600', sizes: '180x180', type: 'image/png' }, // Primary Apple touch icon
      { url: '/images/icon-180x180.png?v=v20250713_1752434150600', sizes: '180x180', type: 'image/png' }, // iPhone 6 Plus and up
      { url: '/images/icon-152x152.png?v=v20250713_1752434150600', sizes: '152x152', type: 'image/png' }, // iPad and iPad mini with @2x
      { url: '/images/icon-144x144.png?v=v20250713_1752434150600', sizes: '144x144', type: 'image/png' }, // Alternative for iPad
      { url: '/images/icon-128x128.png?v=v20250713_1752434150600', sizes: '128x128', type: 'image/png' } // Fallback for older devices
    ]
  },
  ...
  other: {
    ...
    'apple-touch-icon': '/images/icon-180x180.png?v=v20250713_1752434150600',
    'apple-touch-icon-sizes': '180x180',
    // Windows 8/10 tile
    'msapplication-TileImage': '/images/icon-144x144.png?v=v20250713_1752434150600',
  ...
  return (
    <html lang="en" className={`${inter.variable} font-sans`}>
      <head>
        ...
        <link rel="apple-touch-icon" href="/apple-touch-icon.png?v=v20250713_1752434150600" />
        <link rel="apple-touch-icon" sizes="180x180" href="/images/icon-180x180.png?v=v20250713_1752434150600" />
        <link rel="apple-touch-icon" sizes="152x152" href="/images/icon-152x152.png?v=v20250713_1752434150600" />
        <link rel="apple-touch-icon" sizes="144x144" href="/images/icon-144x144.png?v=v20250713_1752434150600" />
        <link rel="apple-touch-icon" sizes="128x128" href="/images/icon-128x128.png?v=v20250713_1752434150600" />
