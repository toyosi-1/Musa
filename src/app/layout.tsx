...
export const metadata: Metadata = {
  ...
  appleWebApp: {
    ...
    startupImage: [
      ...
      { url: '/images/icon-512x512.png?v=v1752600799783', media: '(device-width: 320px) and (device-height: 568px)' },
      // iPhone 8, 7, 6s, 6
      { url: '/images/icon-512x512.png?v=v1752600799783', media: '(device-width: 375px) and (device-height: 667px)' },
      // iPhone 8 Plus, 7 Plus, 6s Plus, 6 Plus
      { url: '/images/icon-512x512.png?v=v1752600799783', media: '(device-width: 414px) and (device-height: 736px)' },
      // iPhone X, XS
      { url: '/images/icon-512x512.png?v=v1752600799783', media: '(device-width: 375px) and (device-height: 812px)' },
      // iPhone XR, XS Max
      { url: '/images/icon-512x512.png?v=v1752600799783', media: '(device-width: 414px) and (device-height: 896px)' },
    ],
  },
  ...
  icons: {
    icon: [
      ...
      { url: '/images/icon-128x128.png?v=v1752600799783', sizes: '128x128', type: 'image/png' },
      { url: '/images/icon-144x144.png?v=v1752600799783', sizes: '144x144', type: 'image/png' },
      { url: '/images/icon-152x152.png?v=v1752600799783', sizes: '152x152', type: 'image/png' },
      { url: '/images/icon-192x192.png?v=v1752600799783', sizes: '192x192', type: 'image/png' },
      { url: '/images/icon-384x384.png?v=v1752600799783', sizes: '384x384', type: 'image/png' },
      { url: '/images/icon-512x512.png?v=v1752600799783', sizes: '512x512', type: 'image/png' },
    ],
    shortcut: [
    ...
    apple: [
      ...
      { url: '/images/icon-128x128.png?v=v1752600799783', sizes: '128x128', type: 'image/png' } // Fallback for older devices
    ]
  },
  ...
  return (
    <html lang="en" className={`${inter.variable} font-sans`}>
      <head>
        ...
        <link rel="apple-touch-icon" sizes="128x128" href="/images/icon-128x128.png?v=v1752600799783" />
