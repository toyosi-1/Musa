...
export default function ScanPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-6 max-w-md">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div className="flex items-center gap-2.5 flex-1">
          ...
          <div>
            ...
            <p className="text-[11px] text-gray-400 dark:text-gray-500">Verify visitor access</p>
          </div>
        </div>
      </div>
      ...
      {scanResult && (
        <div 
          className={`rounded-2xl animate-fade-in border transition-all duration-300 mb-6 text-center overflow-hidden ${
            scanResult.isValid 
      ...
      {!scanResult && (
        <div className="bg-white dark:bg-gray-800/80 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm mb-6 overflow-hidden">
          <div className="aspect-square bg-gray-100 dark:bg-gray-900/50 flex items-center justify-center overflow-hidden">
            {isCameraActive ? (
          ...
          <div className="p-4">
            <button 
              ...
              className={`w-full py-3.5 px-4 rounded-2xl font-bold text-sm transition-all duration-200 flex items-center justify-center gap-2.5 active:scale-[0.98] ${
                isProcessing
      ...
      <div className="bg-white dark:bg-gray-800/80 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-5">
        <div className="flex items-center gap-2.5 mb-3">
          ...
          <h2 className="text-sm font-bold text-gray-900 dark:text-white">How to use</h2>
        </div>
        <ol className="list-decimal pl-5 space-y-2 text-sm text-gray-600 dark:text-gray-300">
          <li>Tap <span className="font-semibold text-teal-600 dark:text-teal-400">Start Camera</span> to activate scanning</li>
