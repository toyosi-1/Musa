    ...
    <div className="container mx-auto px-4 py-6 max-w-md">
      ...
      {step === 'select-disco' && (
        <div className="space-y-4">
          <div className="relative overflow-hidden bg-gradient-to-br from-amber-500 via-orange-500 to-yellow-500 rounded-2xl p-5 mb-2 shadow-lg shadow-amber-500/20">
            ...
            <div className="relative flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-white">Buy Electricity</h2>
                <p className="text-xs text-white/80">Purchase prepaid or postpaid electricity</p>
              </div>
            </div>
          </div>
                ...
                {savedMeters.map((meter) => (
                  ...
                  >
                    <button
                      ...
                      className="flex-1 flex items-center justify-between p-3 bg-amber-50 dark:bg-amber-900/10 rounded-xl border border-amber-200/60 dark:border-amber-700/30 hover:border-amber-400 dark:hover:border-amber-600 transition-all"
                    >
          ...
          {billersLoading ? (
            ...
            <div className="text-center py-8 text-gray-500 dark:text-gray-400">
              <p className="text-sm">No electricity providers available at the moment.</p>
              <button
                onClick={fetchBillers}
                className="mt-2 text-sm font-semibold text-amber-600 dark:text-amber-400 hover:underline"
              >
                ...
                {billers.map((biller) => {
                  ...
                  return (
                    <button
                      ...
                      className="w-full flex items-center justify-between p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-amber-400 dark:hover:border-amber-600 hover:shadow-sm transition-all"
                    >
                      <div className="flex items-center gap-3">
                        <div
                          className="w-10 h-10 rounded-lg flex items-center justify-center shadow-md flex-shrink-0 overflow-hidden bg-white"
                        >
                          {brand.logoImage ? (
                            <img
                              src={brand.logoImage}
                            ...
                            >
                              <svg className="w-5 h-5" viewBox="0 0 24 24" fill={brand.textColor}>
                                <path d={brand.logoSvg} />
                              </svg>
                            </div>
                          )}
                        </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              maxLength={20}
              className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-800 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
            />
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Numbers only, 10-20 digits</p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-800 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
            />
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Minimum: ₦500</p>
          </div>
          ...
          {!meterInfo ? (
            <button
              ...
              className="w-full py-3.5 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-white rounded-2xl font-bold shadow-md shadow-amber-500/20 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
            ...
            <>
              <div className="p-4 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800/50 rounded-xl flex items-start gap-3">
                ...
                <div>
                  <p className="font-bold text-emerald-800 dark:text-emerald-200 text-sm">Meter Validated</p>
              ...
              <label className="flex items-center gap-3 cursor-pointer p-3 bg-gray-50 dark:bg-gray-800/60 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors">
                <input
                  type="checkbox"
                ...
                />
                <span className="text-sm text-gray-600 dark:text-gray-300">Save this meter for quick access next time</span>
              </label>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white dark:bg-gray-800/80 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
            <div className="divide-y divide-gray-50 dark:divide-gray-700/50">
              {[{label:'Provider',value:selectedBiller.name},{label:'Type',value:selectedItem.name},{label:'Customer',value:meterInfo?.customerName||''},{label:'Meter',value:meterNumber},{label:'Phone',value:phoneNumber}].map(row=>(
                <div key={row.label} className="flex justify-between items-center px-4 py-3">
                  <span className="text-sm text-gray-500 dark:text-gray-400">{row.label}</span>
                  <span className="text-sm font-semibold text-gray-800 dark:text-white text-right max-w-[60%] truncate">{row.value}</span>
                </div>
              ))}
              <div className="px-4 py-4 bg-amber-50 dark:bg-amber-900/10">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-2xl font-bold text-amber-600 dark:text-amber-400">₦{parseFloat(amount).toLocaleString()}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full py-3.5 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-white rounded-2xl font-bold shadow-md shadow-amber-500/20 transition-all"
          >
      ...
      {step === 'success' && (
        <div className="space-y-4">
          <div className="flex flex-col items-center py-8">
            ...
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-1">Purchase Successful!</h2>
          ...
          <div className="bg-white dark:bg-gray-800/80 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
            <div className="divide-y divide-gray-50 dark:divide-gray-700/50">
              ...
              <div className="flex justify-between items-center px-4 py-3">
                ...
                <span className="font-mono text-xs text-gray-700 dark:text-gray-300 text-right max-w-[60%] break-all">{transactionRef}</span>
              </div>
              <div className="flex justify-between items-center px-4 py-3">
                <span className="text-sm text-gray-500 dark:text-gray-400">Amount</span>
                <span className="font-bold text-gray-900 dark:text-white">₦{parseFloat(amount).toLocaleString()}</span>
              </div>
              <div className="flex justify-between items-center px-4 py-3">
                <span className="text-sm text-gray-500 dark:text-gray-400">Meter</span>
                <span className="font-semibold text-gray-800 dark:text-white">{meterNumber}</span>
              </div>
            </div>
          </div>
      ...
      {step === 'error' && (
        <div className="space-y-4">
          <div className="flex flex-col items-center py-8">
            ...
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-1">Transaction Failed</h2>
            <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
