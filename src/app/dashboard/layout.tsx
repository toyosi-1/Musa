...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen flex flex-col bg-musa-bg dark:bg-gray-900 safe-area-inset-bottom">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm shadow-lg border-t border-gray-100 dark:border-gray-700 pb-[max(env(safe-area-inset-bottom),0.25rem)] z-50 transform-gpu will-change-transform md:hidden">
        <div className="flex justify-around items-center max-w-md mx-auto px-2 py-1">
          <Link 
            href="/dashboard" 
            className={`flex flex-col items-center justify-center p-1 rounded-lg min-w-[50px] ${
          ...
          {currentUser.role === 'guard' && (
            ...
            >
              <div className="relative -mt-5">
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 w-12 h-12 bg-musa-red hover:bg-red-600 rounded-full flex items-center justify-center shadow-lg transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                </div>
                <span className="text-[10px] font-medium mt-7 block">Scan</span>
              </div>
            </Link>
          )}
          ...
          <div className="relative">
            <button 
              ...
              className="flex flex-col items-center p-1 rounded-lg min-w-[50px] focus:outline-none"
            >
              <div className="w-7 h-7 rounded-full bg-musa-blue/10 dark:bg-blue-900/30 flex items-center justify-center text-musa-blue dark:text-blue-400">
                {currentUser.displayName?.charAt(0).toUpperCase() || 'U'}
              </div>
              <span className="text-[10px] font-medium mt-0.5 text-gray-500 dark:text-gray-400 hover:text-musa-blue dark:hover:text-blue-400 transition-colors truncate max-w-[50px]">
