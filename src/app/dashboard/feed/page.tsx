  ...
  if (!estateId) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] p-6 text-center">
        ...
        <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-2">No Estate Assigned</h2>
        <p className="text-gray-500 dark:text-gray-400">You need to be assigned to an estate to view the feed.</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl mx-auto pb-24">
      ...
      <button
        ...
        className="fixed bottom-20 right-5 md:bottom-8 md:right-8 w-14 h-14 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg flex items-center justify-center transition-all hover:scale-105 z-40"
